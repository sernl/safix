...
- [x] 10.4 `nix flake check` green (log: `logs/8.4-nix-flake-check-retry-20260903-074704.log`, `nix flake check --keep-going --print-build-logs`, "all checks passed!", run by EpicValidation on the merged epic tip per V1(d))
